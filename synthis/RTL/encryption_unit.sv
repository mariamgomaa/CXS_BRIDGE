module encryption_unit  #(
    ...
    input  logic  [2:0]             i_encryption_unit_encryption_mode,   // 0: Even, 1: Odd
    ...
    always_comb begin
        ...
        if ( i_encryption_unit_payload_valid) begin
            ...
            // Even Expansion Mode
            //----------------------------------------
            else if (i_encryption_unit_encryption_mode == 3'b000) begin
            ...
            // Odd Expansion Mode
            //----------------------------------------
            else if (i_encryption_unit_encryption_mode == 3'b001) begin

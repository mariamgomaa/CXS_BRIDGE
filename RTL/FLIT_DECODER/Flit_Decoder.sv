module Flit_Decoder #(
    ...
    //
    // Request a new FIFO entry when:
    //
    // 1. Buffer is empty
    //
    // OR
    //
    // 2. Payload 1 is being consumed and the FIFO
    //    contains another flit.
    //
    // The second case implements prefetching.
    //========================================================
    ...
    always_comb begin
        ...
        //====================================================
        // Case 1:
        // Buffer is empty -> request new flit
        //====================================================
        ...
        //
        // Request the next flit in advance.
        //====================================================
    ...
    //
    // All next-state decisions are made here.
    //========================================================
    ...
    always_comb begin
        ...
        //
        // FIFO data is now available on Data_in.
        //====================================================
        ...
        // It will be captured in the next clock cycle.
        //====================================================
        ...
        // CASE 3:
        //
        // Control Unit consumes current payload.
        //====================================================
    ...
    //
    // Only registers are updated here.
    //========================================================
